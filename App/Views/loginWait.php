...
<head>
    ...
    <title>Başvuru Bekliyor - Restoran Yönetim Paneli</title>
...
<div class="max-w-2xl w-full">
    ...
    <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Başvurunuz Alındı!</h1>
            <p class="text-xl text-gray-600">Restoran kayıt başvurunuz başarıyla gönderildi.</p>
        </div>
        ...
        <div class="bg-gray-50 rounded-xl p-6 mb-8">
            ...
            <div class="space-y-3">
                <div class="flex items-center">
                    ...
                    <span class="font-semibold text-gray-800 ml-2">#REST202500<?= $_GET['id']??0 ?></span>
                </div>
                <div class="flex items-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <button onclick="window.location.href='/yonetim/index'" class="flex-1 bg-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-purple-700 transition duration-300 transform hover:scale-105">
                <i class="fas fa-home mr-2"></i>Restoran Yönetimine Dön
            </button>
            <button onclick="window.location.href='auth/logout'" class="flex-1 bg-gray-200 text-gray-800 py-3 px-6 rounded-lg font-semibold hover:bg-gray-300 transition duration-300 transform hover:scale-105">
                <i class="fas fa-sign-in-alt mr-2"></i>Çıkış Yap
            </button>
        </div>
    </div>
